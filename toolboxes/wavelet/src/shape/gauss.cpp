// toolboxes/wavelet/src/shape/gauss.cpp
//
...
// Compute-only TU: Value substrate + Error, no engine. The gauswavf /
// cgauwavf builtins (CallContext wrappers) live in shape/gauss_reg.cpp.
