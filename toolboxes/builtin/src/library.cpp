...
// all live in toolboxes/stats now (Phase 7b — Statistics Toolbox content
...
// moved to toolboxes/stats (see StatsLibrary::install)
...
// bandwidth _reg adapters → toolboxes/linalg (predicates.cpp)
// vecnorm_reg, rref_reg, rcond_reg, planerot_reg, ldl_reg,
// lsqminnorm_reg, lsqnonneg_reg, balance_reg all migrated to toolboxes/linalg.
...
// File I/O + workspace save/load + CSV moved to toolboxes/io (Phase 7c) —
...
// scan.cpp (still in toolboxes/builtin under language/strings/)
...
// env.cpp (still in toolboxes/builtin under language/commands/)
...
// inv_reg / linsolve_reg → toolboxes/linalg (properties.cpp, solvers.cpp)
// pageinv_reg → toolboxes/linalg (page_ops.cpp)
// trace_reg, det_reg → toolboxes/linalg (properties.cpp)
// chol_reg, lu_reg, qr_reg, svd_reg → toolboxes/linalg (decompositions.cpp)
void topkrows_reg(Span<const Value>, size_t, Span<Value>, CallContext&);
// rank_reg, cond_reg, normest_reg → toolboxes/linalg (properties.cpp)
// pinv_reg, orth_reg, null_reg → toolboxes/linalg (pseudo_subspace.cpp)
// eig_reg, expm_reg, logm_reg, sqrtm_reg, schur_reg, hess_reg,
// sylvester_reg → toolboxes/linalg (eig.cpp, matrix_functions.cpp)
// subspace_reg → toolboxes/linalg (pseudo_subspace.cpp)
// norm_reg → toolboxes/linalg (norms.cpp)
...
// kron_reg → toolboxes/linalg (vector_ops.cpp)
...
// cross_reg, dot_reg → toolboxes/linalg (vector_ops.cpp)
...
void BuiltinLibrary::install(Engine &engine)
{
    ...
    // (toolboxes/optim) with cross-domain top-level promotion to keep MATLAB-base UX.
    ...
    // inv registered by LinalgLibrary::install (toolboxes/linalg).
    // linsolve / pageinv registered by LinalgLibrary::install (toolboxes/linalg).
    // trace / det registered by LinalgLibrary::install (toolboxes/linalg).
    engine.registerFunction("topkrows",  &builtin::detail::topkrows_reg);
    // chol / lu / qr / svd registered by LinalgLibrary::install (toolboxes/linalg).
    ...
    // norm registered by LinalgLibrary::install (toolboxes/linalg).
    // sylvester registered by LinalgLibrary::install (toolboxes/linalg).
    ...
    // compat.norm registered by LinalgLibrary::install (toolboxes/linalg).
    ...
    // LinalgLibrary::install (toolboxes/linalg).
    // compat.linsolve registered by LinalgLibrary::install (toolboxes/linalg).
    ...
    // kron / cross / dot registered by LinalgLibrary::install (toolboxes/linalg).
    ...
    // moved to toolboxes/io (Phase 7c). Their registrations live in
