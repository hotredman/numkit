// toolboxes/audio/src/spectral/fft_one_sided.hpp
//
// Shared per-frame FFT helpers for toolboxes/audio spectral pipelines
// (shape_descriptors, melspec_delta, cepstral). Wraps toolboxes/signal::fft
...
// fs ∈ {8k, 16k, 22.05k, 44.1k}. None are pow2, so until toolboxes/signal
