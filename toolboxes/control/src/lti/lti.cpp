// toolboxes/control/src/lti/lti.cpp
//
...
// Compute-only TU: Value substrate + Error, no engine. The tf/zpk/ss/filt/frd
// constructors + *data extractors (CallContext wrappers) live in lti_reg.cpp.
