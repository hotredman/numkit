// toolboxes/linalg/src/schur_convert.cpp
//
...
// Compute-only TU: Value substrate + Error, no engine. The cdf2rdf/rsf2csf
// builtins (CallContext wrappers) live in schur_convert_reg.cpp.
