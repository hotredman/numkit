#!/usr/bin/env python3
"""
check_api.py — lint public libs/ API headers against dev/LIBRARY_API.md.
...
by the PR checklist in dev/LIBRARY_API.md, not here.
...
§13 exceptions (see dev/LIBRARY_API.md §13):
