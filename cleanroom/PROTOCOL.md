...
| bwmorph | Gonzalez & Woods 4e Ch.9; Pratt 4e §14; Lam/Lee/Suen 1992 | cleanroom/specs/bwmorph.md | clean-room agent (per spec) | (this commit) | gtest 7/7 BwmorphTest (incl. MATLAB-independent invariants test); parity image_bwmorph correctness=OK — bit-exact MATLAB R2025b on all 23 operations (tol=0). Dispatcher clean-roomed; 512-entry LUTs kept as reference data (truth tables of documented ops — facts) |
| dpcmopt | Makhoul 1975; Proakis & Manolakis; Jayant & Noll 1984 | cleanroom/specs/dpcmopt.md | clean-room agent (per spec) | (this commit) | gtest 9/9 DpcmOptTest (incl. MATLAB-independent AR-recovery test); parity dpcmopt correctness=OK — bit-equal MATLAB R2025b |
