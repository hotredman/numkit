...
| `mode` | ✅ | 18.692 | 0.49× |  | OK | Sig: M = mode(X). 1M-pt with ~7919 distinct vals. 50 iters. Scalar fp. DEEP-PROBE 2026-05-29: mode of an EMPTY array -> NaN value + 0 count (not 0x0): mode([])=NaN; [M,F]=mode([]) gives M=NaN, F=0; mode(zeros(0,3))=[NaN NaN NaN] (1x3); mode(zeros(3,0))=1x0. |
