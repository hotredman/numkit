...
| `apskdemod` | ❌ |  |  |  |  |  |
| `mil188qammod` | ❌ | 0.014 | 204.66× |  | OK | MATLAB mil188qammod / mil188qamdemod (MIL-STD-188-110 QAM). Bit-equal with MATLAB R2025b on both M=16 and M=32 constellations. Both tables hard-coded per MATLAB's spec-rounded values (probed at %.17g). KNOWN GAP: M=64, M=256 still deferred (each is a separate constellation table). Octave 11.1.0 doesn't ship mil188qam in core; reports N/A. |
| `mil188qamdemod` | ❌ |  |  |  |  |  |
