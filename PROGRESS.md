...
| `firpm` | ⚠️ | 0.32 | 12.0× | 38.8× | OK | Sig: [b, err] = firpm(N, F, A[, W]). Parks-McClellan optimal equiripple FIR via Remez exchange — Type I (even N). Approx-equal MATLAB R2025b ~5 sig figs on LP / BP / HP / weighted multi-band. KNOWN GAPS: Type II (odd N), 'hilbert' / 'differentiator' ftypes, fresp function-handle, 3rd `res` output struct, lgrid cell override. |
