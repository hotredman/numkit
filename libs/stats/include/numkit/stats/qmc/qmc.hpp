...
Value haltonset(int d, long long skip, long long leap, std::pmr::memory_resource *mr = nullptr);
...
Value net(const Value &stream, long long n, std::pmr::memory_resource *mr = nullptr);
