...
Value mat2gray(const Value &x, double lo = std::numeric_limits<double>::quiet_NaN(), double hi = std::numeric_limits<double>::quiet_NaN(), std::pmr::memory_resource *mr = nullptr);
...
Value ind2gray(const Value &idx, const Value &map, std::pmr::memory_resource *mr = nullptr);
...
Value ind2rgb(const Value &idx, const Value &map, std::pmr::memory_resource *mr = nullptr);
...
Value imcast(const Value &I, const std::string &type, std::pmr::memory_resource *mr = nullptr);
...
Value isbw   (const Value &BW, const std::string &mode, std::pmr::memory_resource *mr = nullptr);
...
Value intlut(const Value &A, const Value &LUT, std::pmr::memory_resource *mr = nullptr);
