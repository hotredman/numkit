// libs/linalg/include/numkit/linalg/pseudo_subspace.hpp
//
// SVD-based pseudoinverse and subspace queries.
// Migrated together with the SVD kernel from libs/builtin/src/
// language/arrays/matrix.cpp (group 4 of the libs/linalg extraction).
