// libs/linalg/include/numkit/linalg/norms.hpp
//
// Vector and matrix norms. Migrated from libs/builtin/src/language/
// arrays/{matrix,predicates}.cpp.
//
// `norm` for the matrix 2-norm (p == 2) routes through `svd_values`,
// which still lives in libs/builtin/include/numkit/builtin/language/
