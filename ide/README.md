...
Alternatively just run `./build-engine.sh --wasm` (Linux/macOS) or `build-engine.bat --wasm` (Windows), then `./web-run.sh` / `web-run.bat` — the dev-run scripts copy the artifacts automatically.
