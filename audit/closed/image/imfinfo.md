# image/imfinfo — ТЗ for completion
...
- Notes: DEFERRED (KNOWN GAP) — requires file I/O round-trip — cannot fit single-snippet spec. Placeholder spec keeps harness green.
