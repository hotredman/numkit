# stats.dist/poissinv — ТЗ for completion
...
- Notes: Pure spec coverage. 10 fingerprints; 6 TEST_F gtest +
  smoke. Parity OK numkit ↔ MATLAB. (Octave gives NaN at lambda=0;
  we follow MATLAB convention.)
