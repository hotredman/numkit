# stats.dist/gprnd — ТЗ for completion
...
- Notes: **DEFERRED via cascade.** This ТЗ is purely about rng-seeded
  ...
  **gprnd() itself is structurally correct** — it is a documented
  ...
  When builtin/rng is reopened and implemented, re-probe gprnd against
...
that foundation, gprnd's inverse-CDF sampler now produces
MATLAB-bit-identical sequences (1 ULP transcendental tolerance on
gevrnd/gprnd, exact on evrnd).

Spec landed: tools/parity/specs/gprnd.json -- correctness=OK.
