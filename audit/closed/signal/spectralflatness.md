...
- Notes: DEFERRED (KNOWN GAP) — name-case gap. numkit registers `spectralflatness` (lowercase); MATLAB ships `spectralFlatness` (camelCase). Easy fix: register a camelCase alias in libs/signal/src/library.cpp.
