# builtin/whos — ТЗ for completion
...
- Notes: DEFERRED (KNOWN GAP) — command-form only — does not return a struct array via `s = whos`. Placeholder spec keeps harness green.
