# builtin/sprintf — ТЗ for completion
...
- Notes: Predicates2 + set-ops + format/transpose batch (26 funcs).
  ...
  KNOWN GAP: numkit sprintf("...") with double-quoted format returns empty; only single-quoted char format works. Documented separately.
