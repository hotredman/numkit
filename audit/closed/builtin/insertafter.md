# builtin/insertafter — ТЗ for completion
...
- Notes: Initial closure was DEFERRED with note 'undefined'. The function insertAfter (camelCase, MATLAB canonical) was already implemented in libs/builtin/src/language/strings/strings.cpp and registered. Fix: also register a lowercase alias 'insertafter' so both spellings work. Bit-identical with MATLAB R2025b on probed input.
