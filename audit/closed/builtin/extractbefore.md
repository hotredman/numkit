# builtin/extractbefore — ТЗ for completion
...
- Notes: Initial closure was DEFERRED with note 'undefined'. The function extractBefore (camelCase, MATLAB canonical) was already implemented in libs/builtin/src/language/strings/strings.cpp and registered. Fix: also register a lowercase alias 'extractbefore' so both spellings work. Bit-identical with MATLAB R2025b on probed input.
