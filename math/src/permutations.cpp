// toolboxes/builtin/src/math/permutations.cpp
//
...
// j = colperm(S) — permutation vector that orders the columns of S by
// ascending count of nonzero entries. Stable: ties broken by original
// column index. Returns a 1-indexed row vector of doubles.
...
// p = symrcm(S) — symmetric reverse Cuthill-McKee ordering. See
// math/permutations.hpp + the algorithm notes on the adapter below.
