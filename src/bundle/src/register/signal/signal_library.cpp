...
// SOS family (toolboxes/signal/src/digital_filtering/sosfilt.cpp)
...
// Savitzky-Golay (toolboxes/signal/src/smoothing/sgolay.cpp)
...
// dB conversions (toolboxes/signal/src/measurements/dbconv.cpp)
...
// Signal stats (toolboxes/signal/src/measurements/signal_stats.cpp)
...
// Spectral metrics (toolboxes/signal/src/spectral_analysis/spectral_metrics.cpp)
...
// Analog filter design (toolboxes/signal/src/filter_design/analog_filters.cpp)
...
// Top-level IIR designs (toolboxes/signal/src/filter_design/iir_designs.cpp)
...
// Signal modelling (toolboxes/signal/src/spectral_analysis/signal_modeling.cpp)
...
// Vibration analysis (toolboxes/signal/src/measurements/vibration.cpp)
...
// Pulse / transition metrics (toolboxes/signal/src/measurements/pulse_metrics.cpp)
...
// Signal ROI utilities (toolboxes/signal/src/measurements/sigroi.cpp)
...
// Signal small utilities (toolboxes/signal/src/measurements/sig_utils.cpp)
...
void SignalLibrary::install(Engine &engine)
{
    ...
    // Skewness now live in toolboxes/audio (per-frame STFT semantics matching
    // MATLAB R2025b Signal Toolbox; see toolboxes/audio/src/spectral/shape_descriptors.cpp).
