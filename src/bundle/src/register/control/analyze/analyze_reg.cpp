// toolboxes/control/src/analyze/analyze_reg.cpp
//
...
void hinfnorm_reg(Span<const Value> a, size_t, Span<Value> o, CallContext &c)
{
    if (a.empty())
        throw Error("hinfnorm: requires sys",
                    0, 0, "hinfnorm", "", "numkit:hinfnorm:nargin");
