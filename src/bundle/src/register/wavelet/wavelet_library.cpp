// toolboxes/wavelet/src/library.cpp
//
...
// dwt/ihaart.cpp
void ihaart_reg   (Span<const Value>, size_t, Span<Value>, CallContext &);
// dwt/wrcoef.cpp
...
void ddencmp_reg  (Span<const Value>, size_t, Span<Value>, CallContext &);
...
void WaveletLibrary::install(Engine &engine)
{
    ...
    reg("dwt",  "ihaart",   &wavelet::detail::ihaart_reg);
    ...
    reg("denoise", "ddencmp",  &wavelet::detail::ddencmp_reg);
