// toolboxes/audio/src/scale/freq_scales.cpp
//
...
#include <numkit/builtin/polyfun.hpp>   // numkit::builtin::pchip (engine-free)
                ...
                std::pmr::memory_resource *mr)
{
    ...
    auto sone2phonInline = [&](double s) -> double {
        ...
        if (s > kTab5Sone[kTab5N - 1]) {
            ...
            Value y = numkit::builtin::pchip(xs_s, ys_p, q, mr);
            phonVal = y.toScalar();
        }
    ...
    return elementwise(mr, phon, [&](double p) {
        ...
        double guess;
        {
            ...
            Value y = numkit::builtin::pchip(xs, ys, q, mr);
            guess = y.toScalar();
        }
