// toolboxes/wavelet/src/dwt/dwt2.cpp
//
...
// Compute-only TU: Value substrate + Error, no engine. The dwt2 / idwt2
// builtins (CallContext wrappers) live in dwt/dwt2_reg.cpp.
