...
import OldConsole from '../Console';
      ...
      <div className="ide-main" style={{ gridTemplateColumns: cols.join(' ') }}>
        {panels.explorer && (
          <aside className="sidebar" style={{ display: 'flex', flexDirection: 'column' }}>
            <FileBrowser
              ...
              defaultGitHubRepo="numkit/numkit-m"
        ...
        {panels.figures && (
          <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            {/* New mockup pane for line plots */}
            {adaptedFigures.length > 0 && (
              <div style={{ flex: droppedFigures > 0 ? 1 : 'unset', minHeight: 0, display: 'flex', flexDirection: 'column' }}>
                <FiguresPane
            ...
            {/* Fallback to legacy renderer for non-line figures (heatmap/bar/etc.) */}
            {droppedFigures > 0 && (
              <div style={{ flex: 1, minHeight: 0, borderTop: '1px solid var(--line)' }}>
                <OldFigures
                  ...
                  onCloseFigure={handleCloseFigure}
                  onCloseAll={handleCloseAllFigures}
                  onClose={() => togglePanel('figures')}
                />
              </div>
            )}
            {adaptedFigures.length === 0 && droppedFigures === 0 && (
              <FiguresPane
                figures={[]}
                onExpand={() => {}}
                onCloseFigure={() => {}}
