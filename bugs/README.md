...
| [builtin/complex-input-unsupported](builtin/complex-input-unsupported.md) | P2 | conv/filter/gradient/movmean/detrend reject complex (trapz+cumtrapz+median+interp1 ✅ 2026-06-05) |
