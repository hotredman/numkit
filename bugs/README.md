...
| [builtin/complex-input-unsupported](builtin/complex-input-unsupported.md) | P2 | conv/filter reject complex (trapz+cumtrapz+median+interp1+gradient+movmean+detrend ✅ 2026-06-05) |
