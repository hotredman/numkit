...
| [stats/distribution-array-params](stats/distribution-array-params.md) | P2 | *pdf/*cdf/*inv broadcast ARRAY params (mu/sigma/n/a/b/df) — norm+exp done (c29); gam/beta/chi2/t/f/rayl/wbl/logn + discrete pending |
