...
| [stats/distribution-array-params](stats/distribution-array-params.md) | P2 | *pdf/*cdf/*inv broadcast ARRAY params (mu/sigma/n/a/b/df) — 10 continuous + bino/poiss/unid/geo done (c29-36); negbin + hypergeom pending |
