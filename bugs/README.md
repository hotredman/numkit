...
| [stats/distribution-array-params](stats/distribution-array-params.md) | P2 | *pdf/*cdf/*inv broadcast ARRAY params (mu/sigma/n/a/b/df) — norm+exp (c29), gam/beta/chi2 pdf+cdf (c30); their inv + t/f/rayl/wbl/logn + discrete pending |
