...
| [builtin/complex-input-unsupported](builtin/complex-input-unsupported.md) | P2 | filter rejects complex (trapz+cumtrapz+median+interp1+gradient+movmean+detrend+conv ✅ 2026-06-05) |
