...
| [builtin/complex-input-unsupported](builtin/complex-input-unsupported.md) | P2 | conv/filter/detrend reject complex (trapz+cumtrapz+median+interp1+gradient+movmean ✅ 2026-06-05) |
