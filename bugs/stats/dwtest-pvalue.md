...
## Fixed
- Fixed: 2026-06-05 (bug-fix loop, cycle 22), `src/toolboxes/stats/src/test/ad_dw.cpp`.
...
- Live guard: `src/toolboxes/stats/tests/dwtest_exact_test.cpp` (5 TEST_F) + flipped
  ...
  `src/toolboxes/stats/tests/smoke/dwtest_exact_smoke.m`.

## References
- `src/toolboxes/stats/src/test/ad_dw.cpp` (dwtest, dwExactPLeft, imhofPLeft)
- MATLAB `doc dwtest`
