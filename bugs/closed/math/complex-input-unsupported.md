...
- ✅ **trapz** — 2026-06-05 (bug-fix loop, cycle 7). Added a `ValueType::COMPLEX`
  ...
  branch covers them. Live guard `src/math/tests/trapz_complex_test.cpp`,
  parity `tools/parity/specs/trapz.json` (OK), smoke
  `src/math/tests/smoke/trapz_complex_smoke.m`.
- ✅ **cumtrapz** — 2026-06-05 (bug-fix loop, cycle 8). Added Complex
  ...
  throws. Live guard `src/math/tests/cumtrapz_complex_test.cpp`, parity
  `tools/parity/specs/cumtrapz.json` (OK), smoke
  `src/math/tests/smoke/cumtrapz_complex_smoke.m`. (Also updated the stale
...
- ✅ **interp1** — 2026-06-05 (bug-fix loop, cycle 10). At the top of
  ...
  `src/math/tests/interp1_complex_test.cpp`, parity
  `tools/parity/specs/interp1.json` (OK), smoke
  `src/math/tests/smoke/interp1_complex_smoke.m`.
- ✅ **gradient** (complex) — 2026-06-05 (bug-fix loop, cycle 11). gradient real
  ...
  `src/math/tests/gradient_complex_test.cpp`, parity
  `tools/parity/specs/gradient.json` (OK), smoke
  `src/math/tests/smoke/gradient_complex_smoke.m`. (N-D `gradient` is still
