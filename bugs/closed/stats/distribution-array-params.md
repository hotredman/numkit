...
- Mechanism (`src/toolboxes/stats/src/distributions/dist_helpers.hpp`):
...
- Guards: `src/toolboxes/stats/tests/dist_broadcast_test.cpp` (36 TEST_F, one block per
  family), `tools/parity/specs/dist_broadcast.json` (correctness=OK vs MATLAB
  R2025b), `src/toolboxes/stats/tests/smoke/dist_broadcast_smoke.m`, and the now-live
...
`src/toolboxes/stats/src/distributions/dist_helpers.hpp`: `broadcast_dist2` (data +
...
`src/toolboxes/stats/tests/dist_broadcast_test.cpp`.
...
## References
- `src/toolboxes/stats/src/distributions/dist_helpers.hpp` (broadcast_dist2/3, dist_param)
- `src/toolboxes/stats/src/distributions/{normal,exponential}.cpp` (kernels + adapters)
- `src/toolboxes/stats/tests/dist_broadcast_test.cpp`, `tools/parity/specs/dist_broadcast.json`
