...
- **Fix:** added direct orthonormal cores `dctType1`/`dctType4` (both
  ...
  `src/toolboxes/signal/tests/dct_types_test.cpp`.
...
## Root cause
`src/toolboxes/signal/src/transforms/dct.cpp:337` (dct) and `:360` (idct) throw for
any Type ≠ 2.
...
## References
- `src/toolboxes/signal/src/transforms/dct.cpp`
