# lang.sort — rejects logical input
...
- Fixed: 2026-06-05 (bug-fix loop, cycle 44),
  `src/lang/src/arrays/matrix.cpp` (`sort_reg`). sort routed
...
- **`sort` on a CHAR array** also threw "Not a double array" — fixed
  2026-06-05 (c45) in `bugs/lang/sort-char.md` (same shape: copyToDouble →
...
## References
- `src/lang/src/arrays/matrix.cpp` (`sort_reg`)
