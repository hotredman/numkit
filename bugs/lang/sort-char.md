...
- Fixed: 2026-06-05 (bug-fix loop, cycle 45),
  `src/lang/src/arrays/matrix.cpp` (`sort_reg`). sort routed char
...
## References
- `src/lang/src/arrays/matrix.cpp` (`sort_reg`, `charizeSortResult`)
