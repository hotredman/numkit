...
- **Fix:** two parts.
  ...
  R2025b. Guard: `src/toolboxes/signal/tests/risetime_falltime_test.cpp`.
...
## Root cause
`risetime`/`falltime` adapters in `src/toolboxes/signal/src/measurements/` emit only
...
## References
- `src/toolboxes/signal/src/measurements/` (risetime/falltime)
- MATLAB `doc risetime`
