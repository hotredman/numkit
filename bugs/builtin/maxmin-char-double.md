# builtin.max/min — return char for char input (should be double)
...
- Live guard: `libs/builtin/tests/maxmin_char_double_test.cpp` (5 TEST_F) +
  ...
  `libs/builtin/tests/smoke/maxmin_char_double_smoke.m`.
