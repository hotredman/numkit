...
- Fixed: 2026-06-05 (bug-fix loop, cycle 46),
  `libs/builtin/src/math/discrete/discrete.cpp` (`unique_reg`). The unique
...
- Live guard: `libs/builtin/tests/unique_typeclass_test.cpp` (6 TEST_F) +
  `BuiltinKnownBug.UniqueTypeClass` flipped live. Parity:
  `tools/parity/specs/unique_typeclass.json` (correctness=OK). Smoke:
  `libs/builtin/tests/smoke/unique_typeclass_smoke.m`.
...
## References
- `libs/builtin/src/math/discrete/discrete.cpp` (`unique_reg`, `narrowUniqueClass`)
- MATLAB `doc unique`
