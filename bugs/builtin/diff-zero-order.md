...
- Live guard: `libs/builtin/tests/diff_order_test.cpp` (3 TEST_F) + flipped
  ...
  `libs/builtin/tests/smoke/diff_order_smoke.m`.

## References
- `libs/builtin/src/language/arrays/matrix.cpp` (diff + diff_reg)
- MATLAB `doc diff`
