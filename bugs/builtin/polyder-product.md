# builtin.polyder — two-arg single-output form returns wrong polynomial
...
- Fixed: 2026-06-05 (bug-fix loop, cycle 55),
  `libs/builtin/src/math/poly/polynomials.cpp` (`polyder_reg`). MATLAB
...
- Live guard: `PolyTest.PolyderProductForm` (new) +
  ...
  `libs/builtin/tests/smoke/polyder_product_smoke.m`.
...
## References
- `libs/builtin/src/math/poly/polynomials.cpp` (`polyder_reg`)
