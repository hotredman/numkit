# builtin.sort — 'MissingPlacement' option silently ignored
...
## Root cause
`sort_reg` (`libs/builtin/src/language/arrays/matrix.cpp`) skipped the
...
## References
- `libs/builtin/src/language/arrays/matrix.cpp` (sort, sortComplex, sort_reg)
