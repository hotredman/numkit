...
for sqrt; `toolboxes/builtin/src/math/trig/trig_{highway,portable}.cpp` for
...
## References
- `toolboxes/builtin/src/math/exp_log/exp_log_{highway,portable}.cpp` (sqrt)
- `toolboxes/builtin/src/math/trig/trig_{highway,portable}.cpp` (acosh/atanh)
...
- Live guard: `toolboxes/builtin/tests/complex_promotion_arrays_test.cpp` (5 cases).
  Parity: `tools/parity/specs/{sqrt,acosh,atanh}.json` extended (correctness=OK).
  Smoke: `toolboxes/builtin/tests/smoke/complex_promotion_arrays_smoke.m`.
