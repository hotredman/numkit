# math.ismember/intersect/setdiff/union — reject char/logical/integer

- **Status:** ✅ FIXED (2026-06-05)
- **Severity:** P2 (throws on valid input MATLAB accepts; setops are common)
- **Kind:** bug
- **Found:** 2026-06-05 (type-input sweep; flagged in bugs/math/unique-typeclass.md)

## Fixed
- Fixed: 2026-06-05 (bug-fix loop, cycle 47),
  `src/math/src/discrete/discrete.cpp`. The set-operation machinery
...
## References
- `src/math/src/discrete/discrete.cpp`
