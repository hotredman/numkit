// toolboxes/signal/src/distributions/normal_reg.cpp
//
...
#include "distributions/dist_helpers.hpp"            // stripUpperFlag / applyUpperInPlace
#include "distributions/normal_detail.hpp"
#include <numkit/value/error.hpp>
