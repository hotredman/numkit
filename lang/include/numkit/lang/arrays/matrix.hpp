...
///
/// **Scope.** This header is the linalg surface of `toolboxes/builtin`: matrix
...
// NOTE: inv migrated to toolboxes/linalg (numkit/linalg/properties.hpp).
...
// NOTE: trace / det migrated to toolboxes/linalg (numkit/linalg/properties.hpp).

// NOTE: chol migrated to toolboxes/linalg (numkit/linalg/decompositions.hpp).
...
//       toolboxes/linalg (numkit/linalg/decompositions.hpp,
//       numkit/linalg/properties.hpp, numkit/linalg/pseudo_subspace.hpp).

// NOTE: cond_2norm migrated to toolboxes/linalg (numkit/linalg/properties.hpp).

// NOTE: orth / null_basis migrated to toolboxes/linalg (numkit/linalg/pseudo_subspace.hpp).

// NOTE: normest migrated to toolboxes/linalg (numkit/linalg/properties.hpp).
...
//       expm, logm_sym, sqrtm_sym migrated to toolboxes/linalg
//       (numkit/linalg/{eig,matrix_functions}.hpp).
// NOTE: subspace migrated to toolboxes/linalg (numkit/linalg/pseudo_subspace.hpp).
// NOTE: norm_value / norm_inf / norm_fro migrated to toolboxes/linalg
...
//       bandwidth / bandwidthOpt migrated to toolboxes/linalg
//       (numkit/linalg/predicates.hpp).

// NOTE: vecnorm migrated to toolboxes/linalg (numkit/linalg/norms.hpp).
...
// NOTE: rcond migrated to toolboxes/linalg (numkit/linalg/properties.hpp).
...
// NOTE: BalanceResult / balance_impl migrated to toolboxes/linalg
//       (numkit/linalg/balance.hpp).
// NOTE: ldl migrated to toolboxes/linalg (numkit/linalg/ldl.hpp).
...
// NOTE: cross / dot / kron migrated to toolboxes/linalg (see
