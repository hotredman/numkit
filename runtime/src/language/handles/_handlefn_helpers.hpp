// toolboxes/builtin/src/datatypes/_handlefn_helpers.hpp
//
                           ...
                           const char *fn)
{
    ...
    case BuiltinFn::Length:
        return ::numkit::lang::length(v, mr);
    case BuiltinFn::Ndims:
        return ::numkit::lang::ndims(v, mr);
    case BuiltinFn::IsEmpty:
    ...
    case BuiltinFn::Sum:  return ::numkit::math::sum (v, mr);
    case BuiltinFn::Prod: return ::numkit::math::prod(v, mr);
    case BuiltinFn::Mean: return ::numkit::math::mean(v, mr);
